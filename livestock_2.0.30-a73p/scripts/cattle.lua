...
mod:registerAssetId("models/Livestock2.fbx/Prefab/CattlePen.Part.005", "PREFAB_LIVESTOCKFARM_CATTLEPEN5")
...
mod:registerPrefabComponent("models/Livestock2.fbx/Prefab/CattlePen.Part.005/Bucket.009", {DataType = "COMP_GROUNDED"})
mod:registerPrefabComponent("models/Livestock2.fbx/Prefab/CattlePen.Part.005/Bucket.010", {DataType = "COMP_GROUNDED"})
mod:registerPrefabComponent("models/Livestock2.fbx/Prefab/CattlePen.Part.005/Bucket.011", {DataType = "COMP_GROUNDED"})
mod:registerPrefabComponent("models/Livestock2.fbx/Prefab/CattlePen.Part.005/Hook.003", {DataType = "COMP_GROUNDED"})
for i = 114, 121, 1 do
	mod:registerPrefabComponent("models/Livestock2.fbx/Prefab/CattlePen.Part.005/Fence." .. string.sub("000" .. i, -3), {DataType = "COMP_GROUNDED"})
end
...
local poly3 = { -- In Blender: looking down, X pointing up
	{ -2.7, 0 },
	{ -2.3, 2.5 },
	{ 0, 2.8 },
	{ 2.3, 2.4 },
...
mod:registerAsset({
    ...
    ConstructorData = {
        DataType = "BUILDING_CONSTRUCTOR_DEFAULT",
        CoreObjectPrefab = "PREFAB_LIVESTOCKFARM_CATTLEPEN5",
        MiniatureConfig = {
            ClipUnderGround = false,
            GroupHeight = 0.0,
            CameraPosition = { 0, 0, 0 },
...
-- mod:registerPrefabComponent("PREFAB_LIVESTOCKFARM_CATTLEPEN5", { DataType = "COMP_LIVESTOCKFARM", PrefabName = "PREFAB_LIVESTOCK_COW", AnimalCount = 1, Radius = 0.2 } )
