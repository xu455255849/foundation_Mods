...
function registerMarketPart( _namePrefab, _nameAsset, _nameFunction)
    ...
    MarketAddition:registerAssetId("models/" .. _namePrefab .. "Part/PATH_A_0_" .. _nameAsset, MarketAdditionPrefix .. "_" .. _nameAsset .. "_PATH_A_0")
    MarketAddition:registerAssetId("models/" .. _namePrefab .. "Part/PATH_A_1_" .. _nameAsset, MarketAdditionPrefix .. "_" .. _nameAsset .. "_PATH_A_1")
    MarketAddition:registerAssetId("models/" .. _namePrefab .. "Part/PATH_A_2_" .. _nameAsset, MarketAdditionPrefix .. "_" .. _nameAsset .. "_PATH_A_2")
    MarketAddition:registerAssetId("models/" .. _namePrefab .. "Part/PATH_A_3_" .. _nameAsset, MarketAdditionPrefix .. "_" .. _nameAsset .. "_PATH_A_3")
    MarketAddition:registerAssetId("models/" .. _namePrefab .. "Part/PATH_B_" .. _nameAsset, MarketAdditionPrefix .. "_" .. _nameAsset .. "_PATH_B")
    MarketAddition:registerPrefabComponent("models/" .. _namePrefab .. "Part", {
        DataType = "COMP_BUILDING_PART",
        PathList = {
            {
                PathType = BUILDING_PATH_TYPE.PICKUP,
                WayPointList = { MarketAdditionPrefix .. "_" .. _nameAsset .. "_PATH_B" }
            },
            {
                PathType = BUILDING_PATH_TYPE.DEFAULT,
                WayPointList = { MarketAdditionPrefix .. "_" .. _nameAsset .. "_PATH_A_0",
                                 MarketAdditionPrefix .. "_" .. _nameAsset .. "_PATH_A_1",
                                 MarketAdditionPrefix .. "_" .. _nameAsset .. "_PATH_A_2",
                                 MarketAdditionPrefix .. "_" .. _nameAsset .. "_PATH_A_3",
                }
            },
        }
    })
